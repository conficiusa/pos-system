/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts --env=development` (hash: dd5f0d9d6e92bd72a98db26780ea523d)
// Runtime types generated with workerd@1.20260317.1 2025-09-27 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DB: D1Database;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* pos */;
	}
}
