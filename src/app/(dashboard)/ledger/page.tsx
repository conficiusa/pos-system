...
const COLS =
  "grid-cols-[88px_minmax(160px,1.5fr)_76px_116px_minmax(140px,1fr)_110px_120px]";

const SkeletonRow = () => (
  <div
    className={cn(
      "grid items-center gap-4 border-b border-pos-border-tertiary px-5 py-3",
      COLS,
    )}
  >
  ...
  const handleExport = () => {
    exportXlsx(
      ...
      filteredEntries.map((e) => [
        ...
        e.customerName,
        e.orderNumber ??
          (e.orderId ? `#${e.orderId.slice(0, 8).toUpperCase()}` : ""),
        e.type,
        e.amount,
        e.description,
        ...
        <div className="flex flex-1 flex-col gap-4 p-5">
              ...
              >
                ...
                <p
                  className={cn(
                    ...
                    metric.valueClass ?? "text-pos-text-primary",
                  )}
                >
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {filterButtons.map((filter) => (
              <Button
                ...
                variant="outline"
                onClick={() =>
                  setTypeFilter(filter.id as "" | "payout" | "credit" | "debit")
                }
                className={cn(
          ...
          <div className="overflow-hidden rounded-[var(--radius-lg)] border border-pos-border-tertiary bg-pos-bg-primary">
            <div className="overflow-x-auto">
              ...
              <div
                className={cn(
                  "grid min-w-205 gap-4 border-b border-pos-border-tertiary bg-pos-bg-secondary px-5 py-2 text-[11px] font-medium uppercase tracking-[0.04em] text-pos-text-tertiary",
                  COLS,
                )}
              >
                <span>Date</span>
                  ...
                  filteredEntries.map((entry) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className={cn(
                            "pt-0.5 font-medium tabular-nums",
                            amountClass,
                          )}
                        >
                          {amountDisplay}
